...
The check-pool section above ends by claiming the check phase's real cost is a 1.4–2.9x gap that list
ordering does not explain, and names it the open question. **That claim is withdrawn.** It compared a model
