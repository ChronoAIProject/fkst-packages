...
- R5: cross-runtime/eventual-consistency contracts → the since-retired assignee lease + create-intent + terminal-table (v6); oracle declared the model soundness-converged.
