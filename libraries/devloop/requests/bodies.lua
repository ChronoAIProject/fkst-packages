...
function C.build_merging_comment_body(M, merge_ready)
  return comment_strings.comment_string(M.output_language, "is_merging_pr_prefix") .. tostring(merge_ready.pr_number)
...
function C.build_merged_comment_body(M, merge_ready, autonomy_record)
  ...
  return comment_strings.comment_string(M.output_language, "merged_pr_prefix") .. tostring(merge_ready.pr_number)
    .. "\n\n" .. M.state_marker(merge_ready.proposal_id, "merging", merge_ready.version)
    .. "\n" .. m_builders.merging_marker(merge_ready.proposal_id, merge_ready.pr_number, merge_ready.version, merge_ready.reviewed_head_sha)
