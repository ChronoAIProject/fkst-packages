...
function fixture.view_comment_json(comment)
...
function fixture.view_comments_json(comments)
  local rendered = {}
  for _, comment in ipairs(comments or {}) do
    table.insert(rendered, fixture.view_comment_json(comment))
  end
  return table.concat(rendered, ",")
end
...
function fixture.issue_view_stdout(fields)
  local f = fields or {}
...
function fixture.pr_view_stdout(fields)
  local f = fields or {}
...
local pr_origin_selector = "title,body,headRefName,headRefOid,baseRefName,state,updatedAt,mergedAt,mergeCommit,comments,labels,author,mergeable,mergeStateStatus"
...
fixture.pr_origin_selector = pr_origin_selector
fixture.pr_origin_legacy_selector = pr_origin_legacy_selector
fixture.pr_head_selector = pr_head_selector
fixture.pr_fix_selector = pr_fix_selector
fixture.pr_fix_precheck_selector = pr_fix_precheck_selector
fixture.pr_merge_selector = pr_merge_selector
fixture.pr_merge_without_rollup_selector = pr_merge_without_rollup_selector
fixture.pr_freshness_selector = pr_freshness_selector
fixture.pr_context_selector = pr_context_selector
...
function fixture.mock_issue_list_command(t, command, issues, times)
  register_view_commands(t, { command }, list_stdout(issues, issue_list_item_json), times or 1)
end

function fixture.mock_pr_list_command(t, command, prs, times)
...
function fixture.mock_pr_list_raw_command(t, command, result, times)
  register_command_result(t, command, result or {}, times or 1)
end

function fixture.mock_issue_board_digest_list_raw(t, repo, result, times)
  fixture.mock_issue_list_raw_command(t, core.gh_issue_list_board_digest_cmd(repo), result, times)
end

function fixture.mock_pr_board_digest_list_raw(t, repo, result, times)
  fixture.mock_pr_list_raw_command(t, core.gh_pr_list_board_digest_cmd(repo), result, times)
end

function fixture.mock_issue_board_digest_list(t, repo, issues, times)
  fixture.mock_issue_list_command(t, core.gh_issue_list_board_digest_cmd(repo), issues, times)
end

function fixture.mock_pr_board_digest_list(t, repo, prs, times)
  fixture.mock_pr_list_command(t, core.gh_pr_list_board_digest_cmd(repo), prs, times)
end

function fixture.mock_issue_view_selector(t, fields, selector, times)
  local f = fields or {}
  local repo = f.repo or "owner/repo"
...
function fixture.mock_pr_view_selector(t, fields, selector, times)
  ...
  }, fixture.pr_view_stdout(f), times or 1)
...
function fixture.mock_pr_view_raw_selector(t, fields, selector, result, times)
  local f = fields or {}
  register_command_result(t, pr_view_command(f.repo or "owner/repo", f.number or 7, selector), result or {}, times or 1)
end

function fixture.mock_issue_read_forms(t, fields)
  local f = fields or {}
  local repo = f.repo or "owner/repo"
  local number = f.number or 42
  ...
  if f.register_all_views == true then
    local stdout = fixture.issue_view_stdout(f)
...
function fixture.mock_pr_read_forms(t, fields)
  local f = fields or {}
  local repo = f.repo or "owner/repo"
  local number = f.number or 7
  ...
  if f.register_all_views == true then
    local stdout = fixture.pr_view_stdout(f)
    local commands = {
  ...
  if f.register_merge_views ~= false and (f.status_check_rollup_json ~= nil or f.merge_view == true or f.register_all_views == true) then
    ...
    }, fixture.pr_view_stdout(f), times)
  end
  mock_probe(t, path, updated_at)
  register_view_commands(t, {
    "gh api " .. shell_quote(path),
...
function fixture.mock_pr_merge_view(t, fields, times)
  local f = fields or {}
  f.merge_view = true
  f.register_merge_views = false
  fixture.mock_pr_read_forms(t, f)
  fixture.mock_pr_view_selector(t, f, pr_merge_selector, times or f.times or 1)
end

function fixture.mock_default_pr_read(t, comments)
  local fields = {
    repo = "owner/repo",
    number = 7,
    comments = comments,
  ...
  fixture.mock_pr_read_forms(t, fields)
  fixture.mock_pr_view_selector(t, fields, pr_origin_selector, fields.times)
end

function fixture.mock_issue_read_with_defaults(t, labels, comments, extra)
  local fields = extra or {}
  fixture.mock_issue_read_forms(t, {
    repo = fields.repo,
