...
function M.observe_now_seconds(facts) return observe_port.observe_now_seconds(facts) end
function M.is_idle_observe(facts) return observe_port.is_idle_observe(facts) end
