...
M.safe_issue = function(...) return base.safe_issue(M, ...) end
...
M.is_opted_in = function(...) return base.is_opted_in(M, ...) end
M.is_intake_held = function(...) return base.is_intake_held(M, ...) end
M.proposal_id = function(...) return base.proposal_id(M, ...) end
...
M.parse_proposal_id = function(...) return base.parse_proposal_id(M, ...) end
M.parse_pr_review_proposal_id = function(...) return base.parse_pr_review_proposal_id(M, ...) end
M.parse_pr_source_ref = function(...) return base.parse_pr_source_ref(M, ...) end
...
M.issue_ref_round_trips = function(...) return base.issue_ref_round_trips(M, ...) end
...
M.neutralize_untrusted_prompt_text = function(...) return base.neutralize_untrusted_prompt_text(M, ...) end
M.quote_untrusted_prompt_text = function(...) return base.quote_untrusted_prompt_text(M, ...) end
M.neutralize_untrusted_comment_text = function(...) return base.neutralize_untrusted_comment_text(M, ...) end
M.normalize_source_ref = function(...) return base.normalize_source_ref(M, ...) end
