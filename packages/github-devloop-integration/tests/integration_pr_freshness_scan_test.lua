...
local function pr_comments(state)
  return {
    markers_builders.pr_origin_marker(core, "github-devloop/issue/owner/repo/42", 42, branch, version, "integration/dev"),
    core.state_marker("github-devloop/issue/owner/repo/42", state or "merge-ready", version),
    markers_builders.review_result_marker(core, review_proposal, "github-devloop/issue/owner/repo/42", "approve", review_dedup),
    markers_builders.merge_ready_marker(core, "github-devloop/issue/owner/repo/42", 7, version, review_proposal, review_dedup, branch_sha),
  }
end
...
return {
  ...
  test_pr_freshness_skips_stale_review_approval_for_new_head = function()
    ...
    mock_pr_view("reviewing", {
      ...
      markers_builders.review_result_marker(core, old_review_proposal, "github-devloop/issue/owner/repo/42", "approve", old_review_dedup),
