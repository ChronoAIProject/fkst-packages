...
return {
  ...
  test_inbound_poll_bounds_and_advances_cache_warm_issue_observations = function()
    ...
    local saw_cache_warm_observation = false
    ...
    for poll = 1, 4 do
      ...
      t.eq(#observed, 1)
      t.eq(type(observed[1].payload.cold_replay), "boolean")
      if observed[1].payload.cold_replay == false then
        saw_cache_warm_observation = true
      end
    ...
    t.is_true(saw_cache_warm_observation)
  end,
