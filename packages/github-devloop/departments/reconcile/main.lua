...
local function pipeline_review(event)
  ...
  with_lock(lock_key, function()
    ...
    local pr_label_request = core.build_reconcile_pr_state_label_request(repo, issue_number, pr_number, reconcile.proposal_id, "blocked", version, reconcile.source_ref)
