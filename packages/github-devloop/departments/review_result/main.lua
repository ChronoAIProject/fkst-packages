...
function pipeline(event)
  ...
  with_lock(lock_key, function()
    ...
    local pr_label_request = core.build_pr_review_result_label_request(origin.repo, origin.issue_number, pr_number, origin.proposal_id, comment_reached, pr_source_ref, issue_version)
