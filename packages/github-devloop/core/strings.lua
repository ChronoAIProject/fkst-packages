...
local strings = {
  en = {
    ...
    merge_gate_fingerprint_label = "Fingerprint: ",
    merge_gate_environment_label = "Environment: ",
  ...
  zh = {
    ...
    merge_gate_fingerprint_label = "指纹：",
    merge_gate_environment_label = "环境对比：",
...
local human_comment_keys = {
  ...
  "merge_gate_fingerprint_label",
  "merge_gate_environment_label",
