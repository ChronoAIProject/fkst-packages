...
add("label:issue:dependency-canonicalization", "implement", "process_ready_event.dependency_hold_label", "label", "lifecycle-authoritative", "state-label:dependency_wait+label:fkst-dev:blocked-on-dependency;dedup=dependency/label/hold")
