...
queue("liveness_scan", "devloop_consensus_request", "lifecycle-authoritative", "consensus-proposal:v1/proposal+dedup")
...
queue("loop", "devloop_consensus_request", "lifecycle-authoritative", "consensus-proposal:v1/proposal+dedup")
queue("observe_issue", "devloop_consensus_request", "lifecycle-authoritative", "consensus-proposal:v1/proposal+dedup")
...
add("comment:issue:consensus-result", "consensus_result", "raise_result_effects.result_comment", "comment", "lifecycle-authoritative", "state:v1+result:v1+projected-label-handoff;dedup=proposal/comment/logical-result")
add("label:issue:consensus-result", "consensus_result", "raise_result_effects.result_label_repair_or_declined", "label", "lifecycle-authoritative", "state-label:declined|visible-marker-repair:ready|dependency_wait;dedup=proposal/label/logical-result")
...
add("label:issue:dependency-canonicalization", "comment_handoff", "act_handoff.projected_state_label", "label", "lifecycle-authoritative", "state-label:ready|dependency_wait+label:fkst-dev:blocked-on-dependency;dedup=embedded-label-request")
...
add("label:issue:awaiting-pr-terminal", "observe_issue", "awaiting_pr_replayer.grant_facade_exit_label", "label", "lifecycle-authoritative", "state-label:merged|blocked;dedup=awaiting-pr/label")
