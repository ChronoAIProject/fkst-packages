...
add("label:issue:consensus-result", "consensus_result", "raise_result_effects.result_label_repair", "label", "lifecycle-authoritative", "state-label:visible-marker-repair:ready|dependency_wait|declined;dedup=proposal/label/logical-result")
