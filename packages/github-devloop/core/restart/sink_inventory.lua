...
add("label:issue:dependency-canonicalization", "implement", "ready_split.raise_ready_split_effects.label", "label", "lifecycle-authoritative", "state-label:dependency_wait+label:fkst-dev:blocked-on-dependency;dedup=dependency/label/hold")
