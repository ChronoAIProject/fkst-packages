...
queue("loop", "devloop_issue_decision", "lifecycle-authoritative", "consensus-result:v1/proposal+dedup")
queue("loop", "devloop_consensus_continue", "lifecycle-authoritative", "consensus-converge:v1/proposal+dedup")
