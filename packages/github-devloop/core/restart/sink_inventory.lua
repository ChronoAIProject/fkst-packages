...
add("label:issue:consensus-result", "consensus_result", "raise_result_effects.result_label", "label", "lifecycle-authoritative", "state-label:ready|dependency_wait|declined;dedup=proposal/label/logical-result")
...
add("label:issue:dependency-hold", "consensus_result", "projected_transition_command.dependency_label", "label", "lifecycle-authoritative", "state-label:dependency_wait+label:fkst-dev:blocked-on-dependency;dedup=projected-transition/label")
...
add("comment:issue:dependency-canonicalization", "implement", "ready_split.raise_ready_split_effects.comment", "comment", "lifecycle-authoritative", "state:v1/dependency_wait+ready-split-canonicalized:v1")
add("label:issue:dependency-canonicalization", "comment_handoff", "act_handoff.projected_label", "label", "lifecycle-authoritative", "state-label:dependency_wait+label:fkst-dev:blocked-on-dependency;dedup=dependency/label/hold")
