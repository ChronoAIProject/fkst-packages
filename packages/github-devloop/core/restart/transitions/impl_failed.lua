...
return function(M, h)
  ...
  return {
    ...
    dedup_shape = "ready/<impl_failed_inner_version> with impl_retry_attempt=<next_implementation_retry_attempt(state.version)>",
    ...
    version_identity = "ready_payload_inner_version(state.version) plus next_implementation_retry_attempt(state.version)",
