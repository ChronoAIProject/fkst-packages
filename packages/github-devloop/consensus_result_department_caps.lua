...
return {
  ...
  dependency_gate_note_markers = function(...) return core.dependency_gate_note_markers(...) end,
  ...
  dependency_release_marker = function(...) return core.dependency_release_marker(...) end,
