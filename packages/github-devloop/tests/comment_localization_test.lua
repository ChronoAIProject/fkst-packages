    ...
    local issue_comments = {
      {
        body = "lorem ipsum " .. cjk_probe .. "\n"
          .. h.state_comment_request(issue_proposal_id, "ready", issue_version).body
    ...
    local review_comments = {
      {
        body = "noise only " .. cjk_probe .. "\n"
          .. h.state_comment_request(issue_proposal_id, "fixing", issue_version .. "/fix/1").body
          .. "\n"
          ...
          .. "\n" .. m_builders.review_meta_marker(issue_proposal_id, review_dedup_key, "fix", issue_version .. "/fix/1", "missing guard", nil, {
