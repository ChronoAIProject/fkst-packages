...
return {
  ...
  test_review_result_approve_marks_issue_merge_ready = function()
    ...
    t.is_true(#label_raise.payload.remove_labels >= 10)
    t.eq(comment_raise.payload.body:find("github-devloop PR review state fact: approve", 1, true), nil)
    t.eq(comment_raise.payload.body:find("Review consensus approves the diff.", 1, true), nil)
    t.eq(pr_comment_raise.payload.pr_number, 7)
    t.is_true(pr_comment_raise.payload.body:find("github-devloop PR review decision: approve", 1, true) ~= nil)
    t.eq(pr_comment_raise.payload.body:find("fkst:github-devloop:state:v1", 1, true), nil)
    t.eq(pr_comment_raise.payload.body:find("fkst:github-devloop:review-result:v1", 1, true), nil)
    t.eq(pr_comment_raise.payload.body:find("fkst:github-devloop:merge-ready:v1", 1, true), nil)
  ...
  test_review_result_reject_marks_issue_fixing = function()
    ...
    t.is_true(#label_raise.payload.remove_labels >= 10)
    t.eq(comment_raise.payload.body:find("Review consensus rejects the diff.", 1, true), nil)
    t.eq(comment_raise.payload.body:find("github-devloop PR review state fact: reject", 1, true), nil)
    t.eq(pr_comment_raise.payload.pr_number, 7)
    t.is_true(pr_comment_raise.payload.body:find("Review consensus rejects the diff.", 1, true) ~= nil)
    t.eq(pr_comment_raise.payload.body:find("fkst:github-devloop:state:v1", 1, true), nil)
    t.eq(pr_comment_raise.payload.body:find("fkst:github-devloop:review-result:v1", 1, true), nil)
