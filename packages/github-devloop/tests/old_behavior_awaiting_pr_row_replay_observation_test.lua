...
local FIXTURES = json_array({
  ...
  -- This one-time integration-merge receipt is the row-local comment effect.
  { name = "rollup-receipt-missing", pr_number = 9808, child_state = "merged", pr_state = "MERGED", rollup_receipt_missing = true, expected_status = "skip-pending", expected_disposition = "skip-pending(rollup-receipt-missing)", expected_effect_ids = json_array({ "comment:issue:awaiting-pr-terminal" }) },
