...
return {
  ...
  test_replayed_fixing_dedup_binds_merge_gate_fact_identity = function()
    ...
    t.is_true(defective.dedup_key:find("/nobase/nopred/norecovery/def456", 1, true) ~= nil)
    t.is_true(corrected.dedup_key:find("/828df8d3/nopred/norecovery/def456", 1, true) ~= nil)
    t.is_true(new_predecessors.dedup_key:find("/nobase/pr5-github-devloop/issue/owner/repo/41-ready-aaa111/norecovery/def456", 1, true) ~= nil)
