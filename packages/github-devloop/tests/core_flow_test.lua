...
return {
  ...
  test_loop_proposals_thread_convergence_narrowing = function()
    ...
    local converge = {
      ...
      angle_digests = {
        { angle = "minimal", verdict = "approve", reply = string.rep("m", 2400), digest = string.rep("n", 2400) },
        { angle = "structural", verdict = "abstain", reply = string.rep("s", 2400), digest = string.rep("t", 2400) },
      },
    }
    ...
    t.eq(#thinking.prior_round_digests[1].reply, 2400)
    t.eq(#thinking.prior_round_digests[2].digest, 2400)
    ...
    t.eq(#review.prior_round_digests[1].reply, 2400)
    t.eq(#review.prior_round_digests[2].digest, 2400)
