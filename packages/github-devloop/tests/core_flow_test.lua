...
return {
  ...
  test_ready_and_implementation_helpers = function()
    ...
    t.eq(pr_safety.is_devloop_issue_branch(core, deterministic_branch), true)
    t.eq(pr_safety.is_devloop_issue_branch(core, "devloop-owner-repo-42-01HY"), false)
    t.eq(pr_safety.is_devloop_issue_branch(core, "feature/unrelated"), false)
