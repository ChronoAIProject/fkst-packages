...
local expected_bytes = table.concat({
  ...
  "implementation-escalating->dependency_wait",
  "implementation-escalating->ready",
  "implementing->awaiting-pr",
  "implementing->blocked",
  "implementing->dependency_wait",
...
local pending_order_goldens = {
  ...
  ["github-devloop/implementing/autonomous/precursor_waiting"] = yes("implementing"),
  ...
  ["github-devloop/implementation-escalating/autonomous/child_dependencies_pending"] = yes("implementation-escalating"),
  ["github-devloop/implementation-escalating/autonomous/child_dependencies_satisfied"] = yes("implementation-escalating"),
