...
local function parent_comments(fixture)
  ...
  if fixture.current_state ~= nil then
    table.insert(comments, comment(
      h.state_comment_request(PROPOSAL_ID, fixture.current_state, fixture.current_version).body,
...
local function child_comments(fixture)
  ...
  if fixture.child_state ~= nil then
    body = body .. "\n" .. h.state_comment_request(PROPOSAL_ID, fixture.child_state, version).body
  end
