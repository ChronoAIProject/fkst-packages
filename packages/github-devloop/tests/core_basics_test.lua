...
return {
  ...
  test_gh_issue_view_state_command_and_parse = function()
    ...
    local closed = core.parse_issue_list_recent_closed('[{"number":41,"title":"Done","closedAt":"2026-06-03T01:02:03Z","labels":[{"name":"fkst-dev:merged"}]}]')
    t.eq(closed[1].number, 41)
    t.eq(closed[1].closed_at, "2026-06-03T01:02:03Z")
    t.eq(closed[1].labels[1], "fkst-dev:merged")
