...
return {
  ...
  test_pr_review_redrive_delivery_dedup_canonicalizes_to_logical_review = function()
    ...
    local generation = generation_prefix .. "missing/1798144657406.0"
  ...
  test_pr_review_redrive_delivery_uses_complete_opaque_fixing_generation = function()
    ...
    local first_row_budget = devloop_base.pr_review_redrive_delivery_dedup_key(review, row_budget_generation, 2)
