...
local FIXTURES = {
  {
    ...
    comments = function()
      return json_array({
        trusted_comment(h.state_comment_request(PROPOSAL_ID, "impl-failed", READY_VERSION).body, "IC_state_impl_failed"),
  ...
  },
  {
    ...
    comments = function()
      return json_array({
        ...
        trusted_comment(h.state_comment_request(PROPOSAL_ID, "blocked", BLOCKED_REVIEW_VERSION).body, "IC_state_blocked_pr"),
  ...
  },
  {
    ...
    comments = function()
      return json_array({
        trusted_comment(h.state_comment_request(PROPOSAL_ID, "implementing", READY_VERSION).body, "IC_state_implementing"),
        trusted_comment(h.state_comment_request(PROPOSAL_ID, "blocked", BLOCKED_TIMEOUT_VERSION).body, "IC_state_blocked_timeout"),
