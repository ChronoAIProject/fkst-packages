...
local function parent_comments(opts)
  ...
  local comments = {
    comment(h.state_comment_request(parent, "awaiting-pr", version).body, core._test_bot_login, "2026-06-03T01:02:03Z"),
  ...
  if options.blocked_visible == true then
    table.insert(comments, comment(
      h.state_comment_request(parent, "blocked", transition_version.next_blocked(version, "child-pr-blocked")).body,
  ...
  return {
    comment(
      m_builders.pr_origin_marker(parent, issue_number, original_branch, version, integration_branch)
        .. "\n" .. h.state_comment_request(parent, "blocked", version).body,
      core._test_bot_login,
