...
return {
  ...
  test_hidden_state_converge_round_fixture_requires_true_stall = function()
    ...
    local positive_facts = conv_rounds.converge_round_facts_for_epoch(positive_entity.comments,
    ...
    local negative_facts = conv_rounds.converge_round_facts_for_epoch(negative_entity.comments,
      "github-devloop/issue/owner/repo/42",
