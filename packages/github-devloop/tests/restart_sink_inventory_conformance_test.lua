...
local semantic_specs = {
  ...
  { "comment:issue:consensus-result", "consensus_result", "raise_result_effects.result_comment", "comment", "lifecycle-authoritative", "state:v1+result:v1;dedup=proposal/comment/logical-result", "packages/github-devloop/departments/consensus_result/main.lua", { "build_result_transition_requests", "comment_request" } },
  { "label:issue:consensus-result", "consensus_result", "raise_result_effects.result_label", "label", "lifecycle-authoritative", "state-label:ready|dependency_wait|declined;dedup=proposal/label/logical-result", "packages/github-devloop/departments/consensus_result/main.lua", { "build_result_transition_requests", "label_request" } },
  ...
  { "comment:issue:dependency-canonicalization", "implement", "process_ready_event.dependency_canonicalization_comment", "comment", "lifecycle-authoritative", "state:v1/dependency_wait+ready-split-canonicalized:v1", "packages/github-devloop/departments/implement/main.lua", { "build_ready_split_transition_requests", "comment_request" } },
  { "label:issue:dependency-canonicalization", "implement", "process_ready_event.dependency_hold_label", "label", "lifecycle-authoritative", "state-label:dependency_wait+label:fkst-dev:blocked-on-dependency;dedup=dependency/label/hold", "packages/github-devloop/departments/implement/main.lua", { "build_ready_split_transition_requests", "label_request" } },
