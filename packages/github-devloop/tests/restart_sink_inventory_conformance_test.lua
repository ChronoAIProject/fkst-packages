...
local semantic_specs = {
  ...
  { "comment:issue:implementation-start", "implement", "raise_implementing_state.comment", "comment", "lifecycle-authoritative", "state:v1/implementing+implement-attempt:v1+optional-operator-command:v1/reimplement;dedup=implement/comment/implementing-state+operator-command-key", "packages/github-devloop/departments/implement/main.lua", { "build_implementing_state_comment_request", "operator_reimplement_applied_body", "raise_implementing_state" } },
