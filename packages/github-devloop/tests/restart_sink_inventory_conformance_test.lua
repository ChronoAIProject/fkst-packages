...
local semantic_specs = {
  ...
  { "label:issue:dependency-hold", "consensus_result", "projected_transition_command.dependency_label", "label", "lifecycle-authoritative", "state-label:dependency_wait+label:fkst-dev:blocked-on-dependency;dedup=projected-transition/label", "libraries/devloop/state.lua", { "dependency_label_change", "_blocked_on_dependency_label", "label_request" } },
