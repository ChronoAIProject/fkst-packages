...
local semantic_specs = {
  ...
  { "label:issue:dependency-hold", "consensus_result", "projected_transition_command.dependency_label", "label", "lifecycle-authoritative", "state-label:dependency_wait+label:fkst-dev:blocked-on-dependency;dedup=projected-transition/label", "libraries/devloop/requests/labels.lua", { "apply_projected_dependency_label", "_blocked_on_dependency_label", "build_state_label_request" } },
  ...
  { "label:issue:dependency-canonicalization", "comment_handoff", "act_handoff.projected_label", "label", "lifecycle-authoritative", "state-label:dependency_wait+label:fkst-dev:blocked-on-dependency;dedup=dependency/label/hold", "packages/github-devloop/departments/comment_handoff/main.lua", { "projected_label_request", "handoff.label_request", "github-proxy.github_issue_label_request" } },
