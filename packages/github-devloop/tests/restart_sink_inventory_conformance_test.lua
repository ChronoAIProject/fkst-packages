...
local semantic_specs = {
  ...
  { "label:issue:consensus-result", "consensus_result", "raise_result_effects.result_label_repair_or_declined", "label", "lifecycle-authoritative", "state-label:declined|visible-marker-repair:ready|dependency_wait;dedup=proposal/label/logical-result", "packages/github-devloop/departments/consensus_result/main.lua", { "build_result_state_label_request", "result_marker_visible" } },
  ...
  { "label:issue:dependency-canonicalization", "comment_handoff", "act_handoff.projected_state_label", "label", "lifecycle-authoritative", "state-label:ready|dependency_wait+label:fkst-dev:blocked-on-dependency;dedup=embedded-label-request", "packages/github-devloop/departments/comment_handoff/main.lua", { "projected_state_label_request", "handoff.label_request", "github-proxy.github_issue_label_request" } },
