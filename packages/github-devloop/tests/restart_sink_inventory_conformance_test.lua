...
local semantic_specs = {
  ...
  { "label:issue:dependency-canonicalization", "implement", "ready_split.raise_ready_split_effects.label", "label", "lifecycle-authoritative", "state-label:dependency_wait+label:fkst-dev:blocked-on-dependency;dedup=dependency/label/hold", "packages/github-devloop/core/ready_split.lua", { "function M.raise_ready_split_effects", "requests_labels.build_state_label_request", "_blocked_on_dependency_label" } },
