...
local semantic_specs = {
  ...
  { "comment:issue:consensus-result", "consensus_result", "raise_result_effects.result_comment", "comment", "lifecycle-authoritative", "state:v1+result:v1+projected-label-handoff;dedup=proposal/comment/logical-result", "packages/github-devloop/departments/consensus_result/main.lua", { "build_result_comment_request", "comment_request" } },
  { "label:issue:consensus-result", "consensus_result", "raise_result_effects.result_label_repair", "label", "lifecycle-authoritative", "state-label:visible-marker-repair:ready|dependency_wait|declined;dedup=proposal/label/logical-result", "packages/github-devloop/departments/consensus_result/main.lua", { "build_result_state_label_request", "result_marker_visible" } },
  ...
  { "label:issue:awaiting-pr-terminal", "observe_issue", "awaiting_pr_replayer.grant_facade_exit_label", "label", "lifecycle-authoritative", "state-label:merged|blocked;dedup=awaiting-pr/label", "packages/github-devloop/core/restart_effect_facade.lua", { "serialize_awaiting_pr_exit_label", "\"label:issue:awaiting-pr-terminal\"" } },
  ...
  { "comment:issue:operator-rereview", "observe_issue", "maybe_apply_issue_rereview_command.applied_comment", "comment", "lifecycle-authoritative", "state:v1/thinking+operator-command:v1/rereview", "packages/github-devloop/departments/observe_issue/operator_recovery.lua", { "maybe_apply_issue_rereview_command", "build_operator_issue_rereview_comment_request" } },
  ...
  { "comment:issue:dependency-waiver", "observe_issue", "maybe_apply_issue_dependency_waiver_command.applied_comment", "comment", "lifecycle-authoritative", "dependency-waiver:v1+operator-command:v1;dedup=dependency-waiver", "packages/github-devloop/departments/observe_issue/operator_recovery.lua", { "maybe_apply_issue_dependency_waiver_command", "dependency_waiver" } },
...
<<<<<<< HEAD
  { "adapter:github.claim-label-add", "observe_issue", "claim_issue_for_management.add_claim_label", "adapter", "grantless-non-lifecycle", "claim-label/add/fkst-dev:claimed[:owner]", "libraries/devloop/claims.lua", { "issue_add_label", "claim-won" } },
  { "adapter:github.claim-label-remove", "observe_issue", "claim_issue_for_management.remove_claim_label", "adapter", "grantless-non-lifecycle", "claim-label/remove/fkst-dev:claimed[:owner]", "libraries/devloop/claims.lua", { "issue_remove_label", "claim-lost" } },
=======
  { "adapter:github.claim-label-add", "observe_issue", "claim_issue_for_management.add_claim_label", "adapter", "grantless-non-lifecycle", "claim-label/add/fkst-dev:claimed[:owner-digest]", "libraries/devloop/claims.lua", { "issue_add_label", "claim-won" } },
  { "adapter:github.claim-label-remove", "observe_issue", "claim_issue_for_management.remove_claim_label", "adapter", "grantless-non-lifecycle", "claim-label/remove/fkst-dev:claimed[:owner-digest]", "libraries/devloop/claims.lua", { "issue_remove_label", "claim-lost" } },
