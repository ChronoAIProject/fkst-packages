...
return {
  ...
  test_marker_label_and_comment_builders = function()
    ...
    local comment = requests_lifecycle.build_result_transition_requests(core, "owner/repo", "42", completed)
  ...
  test_comment_dedup_key_includes_consensus_version = function()
    ...
    local first_comment = requests_lifecycle.build_result_transition_requests(core, "owner/repo", "42", first)
    local second_comment = requests_lifecycle.build_result_transition_requests(core, "owner/repo", "42", second)
  ...
  test_result_comment_neutralizes_untrusted_body_marker_before_real_marker = function()
    ...
    local comment = requests_lifecycle.build_result_transition_requests(core, "owner/repo", "42", event)
