...
local function topology_fixture()
  ...
  b.department("github-proxy.github_entity_changed", { "github-proxy.github_entity_changed_request" }, { "github-proxy.github_entity_changed" })
  ...
  b.department("github-devloop.liveness_scan", { "github-devloop.devloop_liveness_tick" }, { "github-proxy.github_entity_changed_request", "consensus.proposal" })
