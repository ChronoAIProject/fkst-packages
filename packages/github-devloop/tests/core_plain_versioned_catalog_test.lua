...
return {
  ...
  test_consensus_loop_result_orders_after_answered_intake_marker = function()
    ...
    t.eq(core.current_state({
      h.state_comment_request("github-devloop/issue/owner/repo/42", "thinking", intake_version).body,
      h.state_comment_request("github-devloop/issue/owner/repo/42", "ready", consensus_version).body,
