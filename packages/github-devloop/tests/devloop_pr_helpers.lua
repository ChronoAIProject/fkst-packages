...
local function mock_pr_origin(comments, head, head_sha, state, base_branch, is_draft)
...
local function mock_pr_origin_sequence(entries)
  for _, entry in ipairs(entries or {}) do
    ...
    t.mock_command("--json headRefName,headRefOid,baseRefName,state,isDraft,updatedAt,comments", {
      stdout = string.format(
        '{"headRefName":"%s","headRefOid":"%s","baseRefName":"dev","state":"%s","isDraft":false,"updatedAt":"2026-06-03T02:03:04Z","comments":[%s]}\n',
