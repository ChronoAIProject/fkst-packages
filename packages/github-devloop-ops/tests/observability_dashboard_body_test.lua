...
return {
  ...
  test_dashboard_renders_avm_scoreboard_from_trusted_ledger_markers = function()
    ...
    local comments = {
      ...
      trusted_comment(markers_builders.merged_marker(core, proposal_id, "7", second_version, head_sha, record), "2026-06-03T01:30:00Z", 1004),
      untrusted_comment(markers_builders.merged_marker(core, proposal_id, "7", second_version, head_sha, record), "2026-06-03T01:31:00Z", 1005),
    }
    ...
    local recent_prs = {
      {
        ...
        comments = {
          trusted_comment(markers_builders.merged_marker(core, proposal_id, "9", version, head_sha, record), "2026-06-03T01:30:00Z", 2001),
        },
      },
      {
        number = 10,
    ...
    local facts = core.collect_avm_scoreboard_facts({}, 1770000000, {
      {
        ...
        merged_at = "2026-06-03T01:30:00Z",
        comments = {
          trusted_comment(markers_builders.merged_marker(core, proposal_id, "11", version, head_sha, record), "2026-06-03T01:30:00Z", 2021),
        },
      },
    }, {}, {
      {
    ...
    local recent_prs = {
      {
        ...
        merged_at = "2026-06-03T01:30:00Z",
        comments = {
          trusted_comment(markers_builders.merged_marker(core, proposal_id, "14", version, head_sha, record), "2026-06-03T01:30:00Z", 2011),
        },
      },
    }
    local recent_issues = {
    ...
    local facts = core.collect_avm_scoreboard_facts({}, 1770000000, {
      {
        ...
        merged_at = "2026-06-03T01:30:00Z",
        comments = {
          trusted_comment(markers_builders.merged_marker(core, record.proposal_id, "12", record.version, record.head_sha, record), "2026-06-03T01:30:00Z", 2002),
        },
      },
      {
        number = 13,
      ...
      recent_merged_prs = {
        {
          ...
          merged_at = "2026-06-03T01:30:00Z",
          comments = {
            trusted_comment(markers_builders.merged_marker(core, proposal_id, "12", version, head_sha, record), "2026-06-03T01:30:00Z", 3001),
          },
        },
        {
          number = 13,
