...
return {
  test_logs_state_gap_edges_from_trusted_marker_stream = function()
    ...
    mock_pr_list({})
    mock_issue_view({
      render_comment(h.state_comment_request(proposal_id, "ready", "v1").body, "fkst-test-bot", "2026-06-03T01:00:00Z"),
  ...
  test_dashboard_renders_p50_p95_max_and_worst_offenders = function()
    ...
    mock_pr_list({})
    mock_issue_view({
      render_comment(h.state_comment_request(proposal_42, "ready", "v1").body, "fkst-test-bot", "2026-06-03T01:00:00Z"),
      render_comment(core.state_marker(proposal_42, "implementing", "v1"), "fkst-test-bot", "2026-06-03T03:10:00Z"),
    }, 42)
    mock_issue_view({
      render_comment(h.state_comment_request(proposal_43, "ready", "v1").body, "fkst-test-bot", "2026-06-03T01:00:00Z"),
