...
Read the proposal plus the complete Phase B and Phase R transcripts. Verify only citations or claims resolvable inside the in-invocation proposal, context manifest, judged repository checkout when available, and transcripts. Unverified movers have weight zero.
