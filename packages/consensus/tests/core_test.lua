...
local function max_sized_proposal(extra)
  local value = {
    proposal_id = string.rep("p", 200),
    title = string.rep("t", 240),
    body = "body",
    angles = {
      string.rep("a", 200),
      string.rep("b", 200),
    ...
    dedup_key = string.rep("d", 200),
    source_ref = {
      kind = string.rep("k", 200),
      ref = string.rep("r", 200),
    },
  }
  for key, field in pairs(extra or {}) do
    value[key] = field
