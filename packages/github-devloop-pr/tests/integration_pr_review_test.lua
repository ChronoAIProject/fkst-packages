...
return {
  ...
  test_observe_pr_idempotent_reviewing_marker_reraises_until_review_result_visible = function()
    ...
    mock_issue_reviewing({ "fkst-dev:reviewing" }, {
      ...
      markers_builders.review_result_marker(core, review_id, "github-devloop/issue/owner/repo/42", "approve", "consensus:" .. review_id .. "/review"),
    })
  ...
  test_observe_pr_ignores_forged_backpointer_and_uses_pr_native_origin = function()
    mock_pr_origin({
      {
        body = markers_builders.pr_origin_marker(core, "github-devloop/issue/owner/repo/42", "42", "devloop-owner-repo-42-01HY", "v1", "dev"),
  ...
  test_review_pr_long_repo_proposal_id_is_bounded_and_review_runs = function()
    ...
    mock_pr_origin_for({
      ...
      number = 7,
      comments = {
        markers_builders.pr_origin_marker(core, issue_proposal_id, "42", "devloop-owner-repo-42-01HY", version, "dev"),
        core.state_marker(issue_proposal_id, "reviewing", version),
      },
