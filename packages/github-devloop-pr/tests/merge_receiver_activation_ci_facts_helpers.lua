...
function M.delegation_fixtures(ctx)
  ...
  return array({
    ...
    {
      disposition = "own-ci-red-fix-budget-termination", status = "admitted",
      reason = "own-ci-fix-loop-max-rounds", cas = "applied(fix-loop-max-rounds)",
      target = "blocked", source_line = 164,
    ...
    {
      disposition = "verified-classifier-checks-pending-holds", status = "rejected",
      reason = "checks-pending", cas = "hold", target = "hold", source_line = 49,
