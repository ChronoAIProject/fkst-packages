...
local OBSERVATION_PREFIX = "row-replay:github-devloop-pr:observe-pr-local/"
local SITE = {
...
local FIXTURES = json_array({
  ...
  { name = "route-reviewing-untrusted-result", state = "reviewing", marker = "review-result-untrusted", expected_status = "routed", expected_decision = "applied(replay)", expected_target = "reviewing", expected_effect_ids = json_array({ "comment:pr:row-replay" }), evidence_ref = "libraries/devloop/markers/facts.lua:131-145,698-712;packages/github-devloop-pr/core/pr_review_replayer.lua:782-831" },
  { name = "route-reviewing-stale-result", state = "reviewing", marker = "review-result-stale", expected_status = "routed", expected_decision = "applied(replay)", expected_target = "reviewing", expected_effect_ids = json_array({ "comment:pr:row-replay" }), evidence_ref = "libraries/devloop/markers/facts.lua:20-60;packages/github-devloop-pr/core/pr_review_replayer.lua:782-831" },
  ...
  { name = "route-reviewing-approve-without-merge-ready", state = "reviewing", marker = "review-result-approve-only", expected_status = "routed-noop", expected_decision = "skip-foreign(merge-ready)", expected_target = "merge-ready", expected_effect_ids = json_array(), evidence_ref = "packages/github-devloop-pr/core/pr_review_replayer.lua:175-179" },
  { name = "route-reviewing-trusted-approve", state = "reviewing", marker = "review-result", expected_status = "routed", expected_decision = "applied(replay)", expected_target = "merge-ready", expected_effect_ids = json_array({ "queue:github-devloop-pr.devloop_merge_ready" }), evidence_ref = "packages/github-devloop-pr/core/pr_review_replayer.lua:175-189,770-776" },
  { name = "route-reviewing-trusted-reject", state = "reviewing", marker = "review-result-reject", expected_status = "routed", expected_decision = "applied(replay)", expected_target = "fixing", expected_effect_ids = json_array({ "comment:pr:row-replay", "label:issue:row-replay" }), evidence_ref = "packages/github-devloop-pr/core/pr_review_replayer.lua:191-212,770-776" },
  { name = "route-reviewing-nonterminal-converge", state = "reviewing", marker = "review-converge-nonterminal", expected_status = "routed", expected_decision = "applied(replay)", expected_target = "reviewing", expected_effect_ids = json_array({ "comment:pr:row-replay" }), evidence_ref = "packages/github-devloop-pr/core/pr_review_replayer.lua:241-255,778-831" },
  { name = "route-reviewing-terminal-evidence-budget", state = "reviewing", marker = "review-converge-budget", expected_status = "routed", expected_decision = "applied(replay)", expected_target = "blocked", expected_effect_ids = json_array({ "queue:github-devloop-pr.devloop_review_reconcile" }), terminal_cause = "evidence-continuation-budget-exhausted", evidence_ref = "packages/github-devloop-pr/core/pr_review_replayer.lua:241-252,778-780" },
  { name = "route-reviewing-terminal-external-evidence", state = "reviewing", marker = "review-converge-external", expected_status = "routed", expected_decision = "applied(replay)", expected_target = "blocked", expected_effect_ids = json_array({ "queue:github-devloop-pr.devloop_review_reconcile" }), terminal_cause = "external-evidence-required", evidence_ref = "packages/github-devloop-pr/core/pr_review_replayer.lua:241-252,778-780" },
  { name = "route-reviewing-terminal-no-progress", state = "reviewing", marker = "review-converge-stall", expected_status = "routed", expected_decision = "applied(replay)", expected_target = "blocked", expected_effect_ids = json_array({ "queue:github-devloop-pr.devloop_review_reconcile" }), terminal_cause = "no-semantic-progress", evidence_ref = "packages/github-devloop-pr/core/pr_review_replayer.lua:241-252,778-780" },
  { name = "route-reviewing-linked-pr-closed", state = "reviewing", pr_state = "CLOSED", expected_status = "routed", expected_decision = "applied(orphaned-pr-closed)", expected_target = "closed-unmerged", expected_effect_ids = json_array({ "comment:pr:row-replay" }), evidence_ref = "packages/github-devloop-pr/core/pr_review_replayer.lua:52-72,687-698,770-773" },
  { name = "route-reviewing-linked-pr-merged", state = "reviewing", pr_state = "MERGED", expected_status = "routed", expected_decision = "applied(linked-pr-merged)", expected_target = "merged", expected_effect_ids = json_array({ "comment:issue:row-replay", "label:issue:row-replay" }), evidence_ref = "packages/github-devloop-pr/core/pr_review_replayer.lua:52-72,687-698,770-773" },
  { name = "route-reviewing-linked-pr-merged-head-missing", state = "reviewing", pr_state = "MERGED", head_sha = "", expected_status = "routed-noop", expected_decision = "skip-foreign(head)", expected_target = "merged", expected_effect_ids = json_array(), evidence_ref = "packages/github-devloop-pr/core/pr_review_replayer.lua:637-640,687-698,770-773" },
  { name = "route-reviewing-open-head-missing", state = "reviewing", head_sha = "", expected_status = "routed-noop", expected_decision = "skip-foreign(pr-head)", expected_target = "reviewing", expected_effect_ids = json_array(), evidence_ref = "packages/github-devloop-pr/core/pr_review_replayer.lua:41-45,69-70,770-773" },
  ...
  { name = "route-fixing-head-advanced", state = "fixing", suffix = "/fix/1", marker = "fix-feedback-head-advanced", expected_status = "routed", expected_decision = "applied(replay)", expected_target = "reviewing", expected_effect_ids = json_array({ "comment:pr:row-replay", "label:issue:row-replay" }), evidence_ref = "packages/github-devloop-pr/core/pr_review_replayer.lua:275-280" },
  ...
  { name = "route-fixing-ci-repair-redrive", state = "fixing", suffix = "/fix/1", marker = "ci-repair-no-attempt", expected_status = "routed", expected_decision = "applied(replay)", expected_target = "fixing", expected_effect_ids = json_array({ "comment:pr:row-replay" }), evidence_ref = "packages/github-devloop-pr/core/ci_repair_retry.lua:103-107;packages/github-devloop-pr/core/pr_review_replayer.lua:319-336" },
  { name = "route-fixing-ci-repair-due-not-own-ci", state = "fixing", suffix = "/fix/1", marker = "ci-repair-attempt", expected_status = "routed", expected_decision = "applied(replay)", expected_target = "reviewing", expected_effect_ids = json_array({ "comment:pr:row-replay", "label:issue:row-replay" }), evidence_ref = "packages/github-devloop-pr/core/ci_repair_retry.lua:121-171;packages/github-devloop-pr/core/pr_review_replayer.lua:310-315" },
  ...
  { name = "route-fixing-ci-repair-due-own-ci-at-cap", state = "fixing", version = BASE_VERSION .. "/fix/" .. tostring(config.max_fix_rounds()), marker = "ci-repair-attempt", ci = "red", expected_status = "routed", expected_decision = "applied(fix-loop-max-rounds)", expected_target = "blocked", expected_effect_ids = json_array({ "queue:github-devloop-pr.devloop_fix_reconcile", "queue:github-devloop-decompose.devloop_decompose" }), evidence_ref = "packages/github-devloop-pr/core/ci_repair_retry.lua:131-171;packages/github-devloop-pr/core/fix_rounds.lua:164-171" },
  { name = "route-fixing-ci-repair-head-advanced", state = "fixing", suffix = "/fix/1", marker = "ci-repair-attempt", reobserve_head_sha = OTHER_HEAD_SHA, expected_status = "routed", expected_decision = "applied(replay)", expected_target = "reviewing", expected_effect_ids = json_array({ "comment:pr:row-replay", "label:issue:row-replay" }), evidence_ref = "packages/github-devloop-pr/core/ci_repair_retry.lua:164-169;packages/github-devloop-pr/core/pr_review_replayer.lua:310-315" },
  ...
  { name = "route-fixing-linked-pr-closed", state = "fixing", suffix = "/fix/1", pr_state = "CLOSED", expected_status = "routed", expected_decision = "applied(orphaned-pr-closed)", expected_target = "closed-unmerged", expected_effect_ids = json_array({ "comment:pr:row-replay" }), evidence_ref = "packages/github-devloop-pr/core/pr_review_replayer.lua:52-72,261-264,687-698" },
  { name = "route-fixing-linked-pr-merged", state = "fixing", suffix = "/fix/1", pr_state = "MERGED", expected_status = "routed", expected_decision = "applied(linked-pr-merged)", expected_target = "merged", expected_effect_ids = json_array({ "comment:issue:row-replay", "label:issue:row-replay" }), evidence_ref = "packages/github-devloop-pr/core/pr_review_replayer.lua:52-72,261-264,687-698" },
  { name = "route-fixing-linked-pr-merged-head-missing", state = "fixing", suffix = "/fix/1", pr_state = "MERGED", head_sha = "", expected_status = "routed-noop", expected_decision = "skip-foreign(head)", expected_target = "merged", expected_effect_ids = json_array(), evidence_ref = "packages/github-devloop-pr/core/pr_review_replayer.lua:637-640,687-698" },
  { name = "route-fixing-open-head-missing", state = "fixing", suffix = "/fix/1", head_sha = "", expected_status = "routed-noop", expected_decision = "skip-foreign(pr-head)", expected_target = "fixing|reviewing", expected_effect_ids = json_array(), evidence_ref = "packages/github-devloop-pr/core/pr_review_replayer.lua:41-45,69-70,261-264" },
  ...
  { name = "route-review-meta-fix", state = "review-meta", suffix = "/fix/1/meta-fix", marker = "review-meta-fix", expected_status = "routed", expected_decision = "applied(replay)", expected_target = "fixing", expected_effect_ids = json_array({ "comment:pr:row-replay", "label:issue:row-replay" }), evidence_ref = "packages/github-devloop-pr/core/pr_review_replayer.lua:343-375" },
  ...
  { name = "route-review-meta-linked-pr-closed", state = "review-meta", suffix = "/fix/1/meta-closed", pr_state = "CLOSED", expected_status = "routed", expected_decision = "applied(orphaned-pr-closed)", expected_target = "closed-unmerged", expected_effect_ids = json_array({ "comment:pr:row-replay" }), evidence_ref = "packages/github-devloop-pr/core/pr_review_replayer.lua:52-72,343-346,687-698" },
  { name = "route-review-meta-linked-pr-merged", state = "review-meta", suffix = "/fix/1/meta-merged", pr_state = "MERGED", expected_status = "routed", expected_decision = "applied(linked-pr-merged)", expected_target = "merged", expected_effect_ids = json_array({ "comment:issue:row-replay", "label:issue:row-replay" }), evidence_ref = "packages/github-devloop-pr/core/pr_review_replayer.lua:52-72,343-346,687-698" },
  { name = "route-review-meta-linked-pr-merged-head-missing", state = "review-meta", suffix = "/fix/1/meta-merged-no-head", pr_state = "MERGED", head_sha = "", expected_status = "routed-noop", expected_decision = "skip-foreign(head)", expected_target = "merged", expected_effect_ids = json_array(), evidence_ref = "packages/github-devloop-pr/core/pr_review_replayer.lua:637-640,687-698" },
  ...
  { name = "route-merge-ready-no-marker", state = "merge-ready", suffix = "/missing", expected_status = "routed-noop", expected_decision = "skip-foreign(merge-ready)", expected_target = "merging|blocked", expected_effect_ids = json_array(), evidence_ref = "packages/github-devloop-pr/core/pr_review_replayer.lua:398-407" },
  { name = "route-merge-ready-without-approval", state = "merge-ready", suffix = "/no-approval", marker = "merge-ready-only", expected_status = "routed", expected_decision = "applied(replay)", expected_target = "blocked", expected_effect_ids = json_array(), evidence_ref = "packages/github-devloop-pr/core/pr_review_replayer.lua:431-442" },
  { name = "route-merge-ready-stale-head", state = "merge-ready", suffix = "/stale-head", marker = "merge-ready-stale", expected_status = "routed", expected_decision = "applied(replay)", expected_target = "reviewing", expected_effect_ids = json_array({ "comment:pr:row-replay", "label:issue:row-replay" }), evidence_ref = "packages/github-devloop-pr/core/pr_review_replayer.lua:408-430" },
  ...
  { name = "route-merge-ready-linked-pr-closed", state = "merge-ready", suffix = "/closed", pr_state = "CLOSED", expected_status = "routed", expected_decision = "applied(orphaned-pr-closed)", expected_target = "closed-unmerged", expected_effect_ids = json_array({ "comment:pr:row-replay" }), evidence_ref = "packages/github-devloop-pr/core/pr_review_replayer.lua:52-72,398-401,687-698" },
  { name = "route-merge-ready-linked-pr-merged", state = "merge-ready", suffix = "/merged", pr_state = "MERGED", expected_status = "routed", expected_decision = "applied(linked-pr-merged)", expected_target = "merged", expected_effect_ids = json_array({ "comment:issue:row-replay", "label:issue:row-replay" }), evidence_ref = "packages/github-devloop-pr/core/pr_review_replayer.lua:52-72,398-401,687-698" },
  { name = "route-merge-ready-linked-pr-merged-head-missing", state = "merge-ready", suffix = "/merged-no-head", pr_state = "MERGED", head_sha = "", expected_status = "routed-noop", expected_decision = "skip-foreign(head)", expected_target = "merged", expected_effect_ids = json_array(), evidence_ref = "packages/github-devloop-pr/core/pr_review_replayer.lua:637-640,687-698" },
  { name = "route-merge-ready-open-head-missing", state = "merge-ready", suffix = "/open-no-head", head_sha = "", expected_status = "routed-noop", expected_decision = "skip-foreign(pr-head)", expected_target = "merging|blocked", expected_effect_ids = json_array(), evidence_ref = "packages/github-devloop-pr/core/pr_review_replayer.lua:41-45,69-70,398-401" },
  ...
  { name = "route-merging-receiver-redrive", state = "merging", suffix = "/receiver-redrive", marker = "merge-ready", expected_status = "routed", expected_decision = "applied(replay)", expected_target = "merging", expected_effect_ids = json_array({ "queue:github-devloop-pr.devloop_merge_ready" }), evidence_ref = "packages/github-devloop-pr/core/pr_review_replayer.lua:527-538" },
  { name = "route-merging-stale-authorization", state = "merging", suffix = "/stale-auth", marker = "merging-stale", expected_status = "routed", expected_decision = "applied(replay)", expected_target = "reviewing", expected_effect_ids = json_array({ "comment:pr:row-replay", "label:issue:row-replay" }), evidence_ref = "packages/github-devloop-pr/core/pr_review_replayer.lua:520-525" },
  { name = "route-merging-not-mergeable", state = "merging", suffix = "/conflict", marker = "merging", mergeable = false, mergeable_state = "dirty", expected_status = "routed", expected_decision = "applied(replay)", expected_target = "fixing", expected_effect_ids = json_array({ "comment:pr:row-replay", "label:issue:row-replay" }), evidence_ref = "packages/github-devloop-pr/core/pr_review_replayer.lua:539-555" },
  { name = "route-merging-ci-unknown", state = "merging", suffix = "/ci-unknown", marker = "merging", ci = "unknown", expected_status = "routed", expected_decision = "applied(replay)", expected_target = "blocked", expected_effect_ids = json_array(), evidence_ref = "packages/github-devloop-pr/core/pr_review_replayer.lua:557-602" },
  { name = "route-merging-linked-pr-closed", state = "merging", suffix = "/closed", marker = "merging", pr_state = "CLOSED", expected_status = "routed", expected_decision = "applied(orphaned-pr-closed)", expected_target = "closed-unmerged", expected_effect_ids = json_array({ "comment:pr:row-replay" }), evidence_ref = "packages/github-devloop-pr/core/pr_review_replayer.lua:508-519,687-698" },
  { name = "route-merging-linked-pr-merged", state = "merging", suffix = "/merged", marker = "merging", pr_state = "MERGED", expected_status = "routed", expected_decision = "applied(linked-pr-merged)", expected_target = "merged", expected_effect_ids = json_array({ "comment:issue:row-replay", "label:issue:row-replay" }), evidence_ref = "packages/github-devloop-pr/core/pr_review_replayer.lua:508-519,687-698" },
  { name = "route-merging-linked-pr-merged-head-missing", state = "merging", suffix = "/merged-no-head", marker = "merging", pr_state = "MERGED", head_sha = "", expected_status = "routed-noop", expected_decision = "skip-foreign(head)", expected_target = "merged", expected_effect_ids = json_array(), evidence_ref = "packages/github-devloop-pr/core/pr_review_replayer.lua:508-519,637-640,687-698" },
...
local EFFECTS = {
  ["github-proxy.github_issue_comment_request"] = { effect_id = "comment:issue:row-replay", sink_kind = "comment", authority_class = "lifecycle-authoritative" },
  ...
  ["github-proxy.github_issue_label_request"] = { effect_id = "label:issue:row-replay", sink_kind = "label", authority_class = "lifecycle-authoritative" },
  ["devloop_merge_ready"] = { effect_id = "queue:github-devloop-pr.devloop_merge_ready", sink_kind = "queue", authority_class = "lifecycle-authoritative" },
  ...
  ["devloop_fix_reconcile"] = { effect_id = "queue:github-devloop-pr.devloop_fix_reconcile", sink_kind = "queue", authority_class = "lifecycle-authoritative" },
  ["github-devloop-decompose.devloop_decompose"] = { effect_id = "queue:github-devloop-decompose.devloop_decompose", sink_kind = "queue", authority_class = "grantless-published-intent" },
}
...
local function effect_observations(raises)
  ...
  for ordinal, raised in ipairs(raises) do
    ...
    if shape == nil then error("unclassified observe_pr local row replay raise: " .. tostring(raised.queue), 0) end
    table.insert(emitted, { effect_id = shape.effect_id, sink_kind = shape.sink_kind, authority_class = shape.authority_class, ordinal = ordinal })
    table.insert(writes, { effect_id = shape.effect_id, queue = raised.queue })
  end
...
local function assert_row_universe()
  local declared, covered, counts, covered_count = {}, {}, {}, 0
  ...
  t.eq(#FIXTURES, 67, "complete production-reachable observe_pr local row disposition count")
end
...
return {
  test_observe_pr_local_row_replay_old_behavior_is_real_dispatch_and_bidirectional = function()
    ...
    t.eq(#first, 67, "complete production-reachable observe_pr local row replay count")
