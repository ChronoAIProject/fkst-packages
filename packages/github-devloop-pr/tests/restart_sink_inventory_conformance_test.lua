...
local semantic_specs = {
  ...
  { "comment:pr:review-carry-over", "merge", "review_carry_over.raise_review_carry_over.comment", "comment", "lifecycle-authoritative", "state:v1/merge-ready+review-result:v1/approve+merge-ready:v1+review-carry-over:v1+merge_ready-handoff;dedup=review-carry-over/comment/proposal+version+approved-head+new-head", "packages/github-devloop-pr/core/review_carry_over.lua", { "build_review_carry_over_comment_request", "github-proxy.github_pr_comment_request" } },
