...
local queue_policies = {
  ["devloop_review_request"] = { "lifecycle-authoritative", "consensus-proposal:v1/review-proposal+dedup" },
  ["devloop_review_continue"] = { "lifecycle-authoritative", "consensus-converge:v1/review-proposal+dedup" },
  ["devloop_review_decision"] = { "lifecycle-authoritative", "consensus-reached:v1/review-proposal+dedup" },
