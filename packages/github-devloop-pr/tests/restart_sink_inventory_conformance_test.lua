...
local semantic_specs = {
  ...
  { "comment:pr:merging-state", "merge", "write_merging_marker.grant_gated_comment", "comment", "lifecycle-authoritative", "state:v1/merging;dedup=merge/merging/head", "packages/github-devloop-pr/core/merge_executor.lua", { "local function write_merging_marker", "devloop_commands.gh_pr_comment" } },
  ...
  { "adapter:github.pr-ready", "merge", "ensure_pr_ready_for_merge.ready", "adapter", "lifecycle-authoritative", "pr-ready/pr+head", "packages/github-devloop-pr/core/merge_executor.lua", { "local function ensure_pr_ready_for_merge", "devloop_commands.gh_pr_ready" } },
  ...
  { "comment:pr:review-meta-result", "review_meta", "apply_review_meta_decision.grant_facade_comment", "comment", "lifecycle-authoritative", "state:v1/fixing|reviewing|blocked+review-meta:v1", "packages/github-devloop-pr/departments/review_meta/main.lua", { "restart_effect_facade.make", "\"comment:pr:review-meta-result\"" } },
  { "label:issue:review-meta-result", "review_meta", "apply_review_meta_decision.grant_facade_label", "label", "lifecycle-authoritative", "state-label:fixing|reviewing|blocked;dedup=review-meta/label", "packages/github-devloop-pr/departments/review_meta/main.lua", { "facade.emit", "\"github-proxy.github_issue_label_request\"" } },
