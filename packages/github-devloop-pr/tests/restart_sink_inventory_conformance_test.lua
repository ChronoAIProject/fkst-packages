...
local semantic_specs = {
  ...
  { "comment:pr:fix-review-meta", "fix", "raise_review_meta.comment", "comment", "lifecycle-authoritative", "state:v1/review-meta;dedup=fix/review-meta/comment", "packages/github-devloop-pr/departments/fix/main.lua", { "build_fix_review_meta_comment_request", "github-proxy.github_pr_comment_request" } },
  { "label:issue:fix-review-meta", "fix", "raise_review_meta.label", "label", "lifecycle-authoritative", "state-label:review-meta;dedup=fix/review-meta/label", "packages/github-devloop-pr/departments/fix/main.lua", { "build_fix_review_meta_label_request", "github-proxy.github_issue_label_request" } },
  { "comment:pr:fix-merge-gate", "fix", "raise_merge_gate_fix.comment", "comment", "lifecycle-authoritative", "state:v1/fixing+merge-gate:v1;dedup=fix/merge-gate/comment", "packages/github-devloop-pr/departments/fix/main.lua", { "build_merge_gate_fix_comment_request", "github-proxy.github_pr_comment_request" } },
  { "label:issue:fix-merge-gate", "fix", "raise_merge_gate_fix.label", "label", "lifecycle-authoritative", "state-label:fixing;dedup=fix/merge-gate/label", "packages/github-devloop-pr/departments/fix/main.lua", { "requests_labels.build_state_label_request", "github-proxy.github_issue_label_request" } },
  { "comment:pr:ci-repair-attempt", "fix", "ci_repair_attempts.raise_attempt_record", "comment", "lifecycle-authoritative", "ci-repair-attempt:v1;dedup=fix/ci-repair/attempt", "packages/github-devloop-pr/departments/fix/ci_repair_attempts.lua", { "function C.raise_attempt_record", "github-proxy.github_pr_comment_request" } },
  { "comment:pr:ci-repair-blocked", "fix", "ci_repair_attempts.raise_blocked.comment", "comment", "lifecycle-authoritative", "state:v1/blocked+ci-repair:v1;dedup=fix/ci-repair/blocked", "packages/github-devloop-pr/departments/fix/ci_repair_attempts.lua", { "build_ci_failure_unrepaired_blocked_request", "github-proxy.github_pr_comment_request" } },
  { "label:issue:ci-repair-blocked", "fix", "ci_repair_attempts.raise_blocked.label", "label", "lifecycle-authoritative", "state-label:blocked;dedup=fix/ci-repair/label", "packages/github-devloop-pr/departments/fix/ci_repair_attempts.lua", { "function C.raise_blocked", "github-proxy.github_issue_label_request" } },
  ...
  { "git.push:fix-branch", "fix", "publish_fix.push", "git", "lifecycle-authoritative", "git-push/fix-branch/proposal+head", "packages/github-devloop-pr/departments/fix/main.lua", { "git_push_branch", "local push =" } },
  ...
  { "label:issue:review-loop-meta", "review_loop", "act.review_meta_label", "label", "lifecycle-authoritative", "state-label:review-meta;dedup=review-loop/label", "packages/github-devloop-pr/departments/review_loop/main.lua", { "requests_labels.build_state_label_request", "github-proxy.github_issue_label_request" } },
