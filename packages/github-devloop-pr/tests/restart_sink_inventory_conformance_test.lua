...
local semantic_specs = {
  ...
  { "label:issue:liveness-fixing-replay-reviewing", "liveness_scan", "requests_review.raise_fixing_replay_reviewing.label", "label", "lifecycle-authoritative", "state-label:reviewing;dedup=fixing/label/reviewing", "libraries/devloop/requests/review.lua", { "function C.raise_fixing_replay_reviewing", '"fixing", "label", "reviewing"', "github-proxy.github_issue_label_request" } },
