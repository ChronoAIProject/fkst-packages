...
local function mock_queue_pr(event, created_at, state, state_version, base_sha)
  ...
  entity_read_mocks.mock_pr_view_raw_selector(t, { number = event.pr_number }, entity_read_mocks.pr_merge_selector, {
    stdout = string.format(
      '{"headRefName":"%s","headRefOid":"%s","baseRefName":"dev","baseRefOid":"%s","state":"OPEN","updatedAt":"%s","isDraft":false,"mergedAt":"","comments":[%s],"headRepository":{"nameWithOwner":"owner/repo"},"isCrossRepository":false,"mergeable":"MERGEABLE","mergeStateStatus":"CLEAN","statusCheckRollup":[{"name":"ci","status":"COMPLETED","conclusion":"SUCCESS"},{"name":"verification-subject:%s:%s","status":"COMPLETED","conclusion":"SUCCESS"}]}\n',
