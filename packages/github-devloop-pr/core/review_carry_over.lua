...
local function carry_over_risk_gate(repo, pr_number, issue_proposal_id, version, comments, current_head_sha)
  ...
  local fact = markers_facts.high_risk_review_evidence_fact(M,
    comments,
    issue_proposal_id,
    version,
    pr_number,
...
function M.approved_lineage_carry_over(repo, pr_number, issue_proposal_id, version, comments, base_branch, current_head_sha)
  ...
  local fact = markers_facts.merge_ready_fact(M, comments, issue_proposal_id, version, pr_number)
  if fact == nil then
  ...
  local approval_ok = markers_facts.review_result_approval_matches_event(M, comments, approved)
