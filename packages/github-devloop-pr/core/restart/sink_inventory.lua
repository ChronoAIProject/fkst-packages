...
queue("liveness_scan", "devloop_review_request", "grantless-published-intent", "consensus-proposal:v1/review-proposal+dedup")
...
queue("review_loop", "devloop_review_request", "grantless-published-intent", "consensus-proposal:v1/review-proposal+dedup")
queue("review_loop", "devloop_review_reconcile", "grantless-published-intent", "review-reconcile:v1/proposal+round")
queue("review_pr", "devloop_review_request", "grantless-published-intent", "consensus-proposal:v1/review-proposal+dedup")
queue("review_result", "devloop_review_continue", "lifecycle-authoritative", "consensus-converge:v1/review-proposal+dedup")
...
add("label:issue:row-replay", "liveness_scan", "scan.restart_replay_issue_labels", "label", "lifecycle-authoritative", "restart-row-replay/issue-label-families")
...
add("comment:pr:review-meta-result", "review_meta", "apply_review_meta_decision.grant_facade_comment", "comment", "lifecycle-authoritative", "state:v1/fixing|reviewing|blocked+review-meta:v1")
add("label:issue:review-meta-result", "review_meta", "apply_review_meta_decision.grant_facade_label", "label", "lifecycle-authoritative", "state-label:fixing|reviewing|blocked;dedup=review-meta/label")
