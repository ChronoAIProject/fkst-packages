...
queue("review_loop", "devloop_review_meta", "lifecycle-authoritative", "state:v1/review-meta+review+head")
...
add("comment:pr:fix-review-meta", "fix", "raise_review_meta.comment", "comment", "lifecycle-authoritative", "state:v1/review-meta;dedup=fix/review-meta/comment")
add("label:issue:fix-review-meta", "fix", "raise_review_meta.label", "label", "lifecycle-authoritative", "state-label:review-meta;dedup=fix/review-meta/label")
add("comment:pr:fix-merge-gate", "fix", "raise_merge_gate_fix.comment", "comment", "lifecycle-authoritative", "state:v1/fixing+merge-gate:v1;dedup=fix/merge-gate/comment")
add("label:issue:fix-merge-gate", "fix", "raise_merge_gate_fix.label", "label", "lifecycle-authoritative", "state-label:fixing;dedup=fix/merge-gate/label")
...
add("comment:pr:ci-repair-blocked", "fix", "ci_repair_attempts.raise_blocked.comment", "comment", "lifecycle-authoritative", "state:v1/blocked+ci-repair:v1;dedup=fix/ci-repair/blocked")
add("label:issue:ci-repair-blocked", "fix", "ci_repair_attempts.raise_blocked.label", "label", "lifecycle-authoritative", "state-label:blocked;dedup=fix/ci-repair/label")
...
add("label:issue:review-loop-meta", "review_loop", "act.review_meta_label", "label", "lifecycle-authoritative", "state-label:review-meta;dedup=review-loop/label")
