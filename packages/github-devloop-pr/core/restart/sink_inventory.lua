...
queue("review_loop", "devloop_review_continue", "lifecycle-authoritative", "consensus-converge:v1/review-proposal+dedup")
queue("review_loop", "devloop_review_decision", "lifecycle-authoritative", "consensus-reached:v1/review-proposal+dedup")
queue("review_loop", "devloop_review_reconcile", "grantless-published-intent", "review-reconcile:v1/proposal+round")
queue("review_pr", "devloop_review_request", "lifecycle-authoritative", "consensus-proposal:v1/review-proposal+dedup")
