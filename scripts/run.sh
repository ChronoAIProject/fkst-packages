...
cmd_check() {
  ...
  python3 -B "$ROOT/scripts/check_repo_test.py" || fail=1; python3 -B "$ROOT/scripts/check_repo_error_class_test.py" || fail=1; python3 -B "$ROOT/scripts/check_repo_shell_out_to_self_test.py" || fail=1; python3 -B "$ROOT/scripts/check_repo_hidden_state_test.py" || fail=1
