...
cmd_check() {
  ...
  local -a units=(
    ...
    'python3 -B "$ROOT/scripts/run_typed_unittest.py" "$ROOT/scripts/ci_workflow_test.py"'
    'python3 -B "$ROOT/scripts/run_typed_unittest.py" "$ROOT/scripts/ratchet_base_test.py"'
    'python3 -B "$ROOT/scripts/check_repo_fkst_layout.py"'
<<<<<<< HEAD
    'python3 -B "$ROOT/scripts/run_typed_unittest.py" "$ROOT/scripts/check_repo_dedup_test.py"'
    'python3 -B "$ROOT/scripts/run_typed_unittest.py" "$ROOT/scripts/check_repo_intent_bounded_replay_test.py"'
    'python3 -B "$ROOT/scripts/run_typed_unittest.py" "$ROOT/scripts/check_repo_intent_bounded_replay_checker_test.py"'
    'python3 -B "$ROOT/scripts/run_typed_unittest.py" "$ROOT/scripts/check_repo_intent_delivery_authorization_test.py"'
    'python3 -B "$ROOT/scripts/run_typed_unittest.py" "$ROOT/scripts/check_repo_intent_bounded_replay_semantic_tree_test.py"'
    'python3 -B "$ROOT/scripts/run_typed_unittest.py" "$ROOT/scripts/check_repo_content_truncation_test.py"'
    'python3 -B "$ROOT/scripts/run_typed_unittest.py" "$ROOT/scripts/check_repo_bot_login_mediation_test.py"'
    'python3 -B "$ROOT/scripts/run_typed_unittest.py" "$ROOT/scripts/check_repo_fanout_only_test.py"'
    'python3 -B "$ROOT/scripts/run_typed_unittest.py" "$ROOT/scripts/check_repo_coverage_test.py"'
    'python3 -B "$ROOT/scripts/run_typed_unittest.py" "$ROOT/scripts/check_repo_devloop_godlib_test.py"'
    'python3 -B "$ROOT/scripts/run_typed_unittest.py" "$ROOT/scripts/check_repo_devloop_installer_test.py"'
    'python3 -B "$ROOT/scripts/run_typed_unittest.py" "$ROOT/scripts/check_repo_integration_coverage_test.py"'
    'python3 -B "$ROOT/scripts/run_typed_unittest.py" "$ROOT/scripts/check_repo_intake_default_surface_test.py"'
    'python3 -B "$ROOT/scripts/run_typed_unittest.py" "$ROOT/scripts/check_repo_dead_letter_test.py"'
    'python3 -B "$ROOT/scripts/run_typed_unittest.py" "$ROOT/scripts/check_repo_dead_locals_test.py"'
    'python3 -B "$ROOT/scripts/run_typed_unittest.py" "$ROOT/scripts/check_repo_producer_liveness_test.py"'
    'python3 -B "$ROOT/scripts/run_typed_unittest.py" "$ROOT/scripts/check_repo_monotone_gate_test.py"'
    'python3 -B "$ROOT/scripts/run_typed_unittest.py" "$ROOT/scripts/check_repo_test_graphql.py"'
    'python3 -B "$ROOT/scripts/run_typed_unittest.py" "$ROOT/scripts/check_repo_interface_test.py"'
    'python3 -B "$ROOT/scripts/run_typed_unittest.py" "$ROOT/scripts/lua_coverage_to_lcov_test.py"'
    'python3 -B "$ROOT/scripts/run_typed_unittest.py" "$ROOT/scripts/check_repo_test.py"'
    'python3 -B "$ROOT/scripts/run_typed_unittest.py" "$ROOT/scripts/check_repo_library_layering_test.py"'
    'python3 -B "$ROOT/scripts/run_typed_unittest.py" "$ROOT/scripts/run_script_contract_test.py"'
    'python3 -B "$ROOT/scripts/run_typed_unittest.py" "$ROOT/scripts/run_typed_unittest_test.py"'
    'python3 -B "$ROOT/scripts/run_typed_unittest.py" "$ROOT/scripts/check_repo_gh_git_adapter_test.py"'
    'python3 -B "$ROOT/scripts/run_typed_unittest.py" "$ROOT/scripts/check_repo_github_content_ingress_test.py"'
    'python3 -B "$ROOT/scripts/run_typed_unittest.py" "$ROOT/scripts/check_repo_error_class_test.py"'
    'python3 -B "$ROOT/scripts/run_typed_unittest.py" "$ROOT/scripts/check_repo_library_error_class_test.py"'
    'python3 -B "$ROOT/scripts/run_typed_unittest.py" "$ROOT/scripts/check_repo_dependency_cycle_test.py"'
    'python3 -B "$ROOT/scripts/run_typed_unittest.py" "$ROOT/scripts/check_repo_shell_out_to_self_test.py"'
    'python3 -B "$ROOT/scripts/run_typed_unittest.py" "$ROOT/scripts/check_repo_hidden_state_test.py"'
    'python3 -B "$ROOT/scripts/run_typed_unittest.py" "$ROOT/scripts/check_repo_std_dependency_model_test.py"'
    'python3 -B "$ROOT/scripts/run_typed_unittest.py" "$ROOT/scripts/check_repo_saga_head_test.py"'
    'python3 -B "$ROOT/scripts/run_typed_unittest.py" "$ROOT/scripts/check_repo_namespaced_queue_test.py"'
    'python3 -B "$ROOT/scripts/run_typed_unittest.py" "$ROOT/scripts/check_repo_fkst_layout_test.py"'
    'python3 -B "$ROOT/scripts/run_typed_unittest.py" "$ROOT/scripts/check_repo_restart_lifecycle_test.py"'
    'python3 -B "$ROOT/scripts/run_typed_unittest.py" "$ROOT/scripts/check_repo_restart_preflight_test.py"'
    'python3 -B "$ROOT/scripts/run_typed_unittest.py" "$ROOT/scripts/bin_cache_test.py"'
    'python3 -B "$ROOT/scripts/run_typed_unittest.py" "$ROOT/scripts/bin_bootstrap_test.py"'
    'python3 -B "$ROOT/scripts/run_typed_unittest.py" "$ROOT/scripts/host_entry_test.py"'
    'python3 -B "$ROOT/scripts/run_typed_unittest.py" "$ROOT/scripts/run_bin_test.py"'
    'python3 -B "$ROOT/scripts/run_typed_unittest.py" "$ROOT/scripts/host_run_test.py"'
    'python3 -B "$ROOT/scripts/run_typed_unittest.py" "$ROOT/scripts/host_run_restart_test.py"'
    'python3 -B "$ROOT/scripts/run_typed_unittest.py" "$ROOT/scripts/host_run_source_identity_test.py"'
    'python3 -B "$ROOT/scripts/run_typed_unittest.py" "$ROOT/scripts/host_run_local_iteration_test.py"'
    'python3 -B "$ROOT/scripts/run_typed_unittest.py" "$ROOT/scripts/host_run_process_group_test.py"'
    'python3 -B "$ROOT/scripts/run_typed_unittest.py" "$ROOT/scripts/host_profile_scaffold_test.py"'
    'python3 -B "$ROOT/scripts/run_typed_unittest.py" "$ROOT/scripts/host_run_equivalence_test.py"'
    'python3 -B "$ROOT/scripts/run_typed_unittest.py" "$ROOT/scripts/run_sh_coverage_test.py"'
    'python3 -B "$ROOT/scripts/run_typed_unittest.py" "$ROOT/scripts/run_sh_test_affected_test.py"'
    'python3 -B "$ROOT/scripts/run_typed_unittest.py" "$ROOT/scripts/run_sh_test_deadline_test.py"'
    'python3 -B "$ROOT/scripts/run_typed_unittest.py" "$ROOT/scripts/dogfood_reaper_test.py"'
    'python3 -B "$ROOT/scripts/run_typed_unittest.py" "$ROOT/scripts/composed_manifest_test.py"'
    'python3 -B "$ROOT/scripts/run_typed_unittest.py" "$ROOT/scripts/board_test.py"'
    'python3 -B "$ROOT/scripts/run_typed_unittest.py" "$ROOT/scripts/dogfood_board_test.py"'
    'python3 -B "$ROOT/scripts/run_typed_unittest.py" "$ROOT/scripts/dogfood_split_test.py"'
    'python3 -B "$ROOT/scripts/run_typed_unittest.py" "$ROOT/scripts/durable_health_test.py"'
    'python3 -B "$ROOT/scripts/run_typed_unittest.py" "$ROOT/scripts/tmp_receipt_sweep_test.py"'
    'python3 -B "$ROOT/scripts/run_typed_unittest.py" "$ROOT/scripts/doctor_test.py"'
    'python3 -B "$ROOT/scripts/run_typed_unittest.py" "$ROOT/scripts/ratchet_migration_slicer_test.py"'
    'python3 -B "$ROOT/scripts/run_typed_unittest.py" "$ROOT/scripts/competence_gate_test.py"'
    'python3 -B "$ROOT/scripts/run_typed_unittest.py" "$ROOT/scripts/test_parallel_test.py"'
=======
...
>>>>>>> 2ec2f80260eca79fd2935a849b9682afd86d23e2
  )
  ...
  case "${RUN_UNITS_FAIL_CODES:-}" in
    ...
    12) local_iteration_result_fail "INFRASTRUCTURE" ;;
  esac
