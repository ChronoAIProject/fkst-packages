...
def messages(
    ...
    if base_status == "unresolved":
        result.append(check_repo_config.configuration_failure("cannot resolve dev base allowlist to enforce shrink-only dependency-cycle ratchet; ensure CI provides the dev ref"))
